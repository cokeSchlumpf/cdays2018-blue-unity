package com.ibm.cdays.common.config;
...
public class Configs {
     ...
     */
    public static final String ENV_IRE_ENVIRONMENT = "cdays.environment";
    /**
     * The name of the system variable which is used to store the role of the cdays instance
     */
    public static final String ENV_IRE_ROLE = "cdays.role";
    /**
            ...
            FieldUtils
                ...
                .forEach(field -> {
                    ...
                    try {
                        ...
                        } else if (field.getType().equals(Config.class)) {
                            // Config object
                        ...
                        if (field.getAnnotationsByType(com.ibm.cdays.common.config.annotations.Optional.class) == null) {
                            throw e;
                        } // else ignore that exception
                    } catch (IllegalAccessException e) {
                        // TODO: better error handling, but actually this error should never happen
